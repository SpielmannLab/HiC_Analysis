...
mkdir -p $WORK/compare_hic_matrices_launchdir
rsync --exclude "slurm*" -rc --update * $WORK/compare_hic_matrices_launchdir/
cd $WORK/compare_hic_matrices_launchdir
...
nextflow run main.nf -params-file params.yaml -resume -ansi-log false
