...
mkdir -p $WORK/ab_compartment_launchdir
rsync --exclude "slurm*" -rc --update * $WORK/ab_compartment_launchdir/
cd $WORK/ab_compartment_launchdir
...
nextflow run main.nf -params-file params.yaml -resume -ansi-log false -profile omics
